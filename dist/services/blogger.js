...
let AuthService = class AuthService {
    ...
    async SignUp(userInputDTO) {
        try {
            const userRecord = await blogger_1.default.create(Object.assign(Object.assign({}, userInputDTO), { password: userInputDTO.password }));
            if (!userRecord) {
    ...
    async SignIn(email, password) {
        const userRecord = await blogger_1.default.findOne({ email });
        if (!userRecord) {
